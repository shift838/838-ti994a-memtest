#define VDP_REG_WRITE 0x8C02
#define MY_VDP_SET_REG(r, v) { *((volatile char*)VDP_REG_WRITE) = (v); *((volatile char*)VDP_REG_WRITE) = (0x80 | (r)); }
#include <vdp.h>
#include <system.h>
#include <string.h>
...
{
  set_text();
  MY_VDP_SET_REG(VDP_REG_COL, SCREEN_COLOR);
